...
func (r ApiGetLogRequest) Execute() (InlineResponse2001, *_nethttp.Response, error) {
...
func (a *TaskInstanceApiService) GetLogExecute(r ApiGetLogRequest) (InlineResponse2001, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
