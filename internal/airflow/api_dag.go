...
func (r ApiGetDagSourceRequest) Execute() (InlineResponse200, *_nethttp.Response, error) {
...
func (a *DAGApiService) GetDagSourceExecute(r ApiGetDagSourceRequest) (InlineResponse200, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
